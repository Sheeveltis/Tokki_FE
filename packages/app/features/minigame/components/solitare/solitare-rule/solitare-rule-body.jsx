...
/**
 * Nội dung luật chơi solitaire
 */
export function SolitareRuleBody({ onStart }) {
  return (
      ...
      <View style={styles.card}>
        ...
        <View style={styles.body}>
          ...
          <Text style={styles.paragraph}>
            Bạn cần phải xem thẻ bài từ vựng để sắp xếp theo chủ đề đã được hiển thị.
          </Text>
          <Text style={styles.paragraph}>
            Nếu đạt đủ số lượng thẻ bài theo từng chủ đề thì sẽ hoàn thành chọn những từ vựng dành cho chủ đề đó.
          </Text>
...
export default SolitareRuleBody
