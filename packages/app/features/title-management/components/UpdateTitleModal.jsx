  ...
  useEffect(() => {
    if (open && initialData) {
      form.setFieldsValue({
        ...
        requirementType: initialData.requirementType ?? 0,
        requirementQuantity: initialData.requirementQuantity ?? 0,
    ...
    >
      ...
      >
        <Row gutter={24}>
          ...
          <Col span={10}>
            <Form.Item label={<Space><PictureOutlined style={{ color: '#1677ff' }} />Biểu tượng (Icon)</Space>}>
