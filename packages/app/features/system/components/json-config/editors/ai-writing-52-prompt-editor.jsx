...
export const AIWriting52PromptEditor = ({ form }) => {
...
QUY TẮC VĂN PHONG VĂN VIẾT (서술체):
...
YÊU CẦU ĐẦU RA (JSON THUẦN TÚY):
{
        ...
        <div style={{ padding: '20px 0' }}>
          <Row gutter={24}>
            <Col span={24}>
              ...
              >
                <Input.TextArea 
                  placeholder="Ví dụ: Bạn là giáo viên chấm thi TOPIK II Writing câu 52..." 
            ...
            <Col span={24}>
              ...
              >
                <Input.TextArea 
                  placeholder="Mô tả về yêu cầu và cách tính điểm tổng quát của câu 52..." 
    ...
    },
    {
      ...
      children: (
        <div style={{ padding: '20px 0' }}>
          ...
          >
            <Input.TextArea 
              placeholder="Quy định về văn phong khách quan (서술체)..." 
  ...
  return (
    <div style={{ padding: '0 4px' }}>
      <div style={{ marginBottom: 16, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <Space direction="vertical" size={0}>
          <Paragraph type="secondary" style={{ margin: 0 }}>
            <InfoCircleOutlined /> Cấu hình Prompt TOPIK Writing Câu 52.
          </Paragraph>
      ...
      <Modal
        title="Xem trước Prompt Writing 52"
        open={previewOpen}
