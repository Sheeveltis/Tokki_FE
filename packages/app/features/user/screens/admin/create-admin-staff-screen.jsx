    ...
    >
      ...
      >
        ...
        >
                    ...
                    <Col span={24}>
                      <div style={{ display: 'flex', gap: 48 }}>
                        <div style={{ maxWidth: '100%' }}>
                          ...
                          <Text strong style={{ fontSize: 13, display: 'block' }} ellipsis={{ tooltip: email }}>
                            {email || '-'}
                          </Text>
                        </div>
                        <div style={{ maxWidth: '100%' }}>
                          ...
                          <Text strong style={{ fontSize: 13, display: 'block' }} ellipsis={{ tooltip: phoneNumber }}>
                            {phoneNumber || '-'}
                          </Text>
                        </div>
                      </div>
          ...
          <Row gutter={[16, 16]} style={{ margin: 0, width: '100%', marginTop: 12 }}>
            <Col xs={24} sm={24} md={24}>
              <Card
                ...
                <Descriptions column={2} size="small" bordered>
                  ...
                  <Descriptions.Item label="Email">
                    <Form.Item name="email" noStyle rules={[
                      ...
                      <Input placeholder="email@example.com" size="middle" maxLength={120} />
                    </Form.Item>
                  </Descriptions.Item>
                  <Descriptions.Item label="Số điện thoại">
                    <Form.Item name="phoneNumber" noStyle rules={[{ required: true, message: 'Vui lòng nhập số điện thoại' }]}>
                      <Input placeholder="Số điện thoại" size="middle" maxLength={12} />
                    </Form.Item>
                  </Descriptions.Item>
