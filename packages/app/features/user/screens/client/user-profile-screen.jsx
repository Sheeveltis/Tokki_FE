...
const LazyProfile = lazy(() => import('./profile-screen'))
const LazyDetail = lazy(() => import('../mobile/user-detail-screen'))
const LazyPaymentHistory = lazy(() => import('./payment-history-screen'))
