 ...
 */
export function ExamTemplateApprovalModal({ open, loading, onCancel, onSubmit, initialApprovalType = 'approve' }) {
      ...
      <Form form={form} layout="vertical" requiredMark={false}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
                ...
                <div style={{ textAlign: 'center' }}>
                  ...
                  <div style={{ 
                    ...
                    Mẫu đề sẽ không được kích hoạt
                  </div>
                </div>
                {isReject && (
                  <div style={{
          ...
          >
            <Space>
              ...
              <span style={{ fontSize: 14, color: '#047857', lineHeight: 1.6 }}>
                Mẫu đề sẽ được chuyển sang trạng thái <strong>"Đã xuất bản"</strong> sau khi bạn xác nhận phê duyệt.
              </span>
            </Space>
          </div>
        )}
        ...
        {isReject && (
          ...
          >
            <TextArea
              rows={4}
              placeholder="Vui lòng nhập lý do chi tiết để người tạo mẫu đề có thể cải thiện..."
              style={{ 
                fontSize: 14,
                borderRadius: 8,
