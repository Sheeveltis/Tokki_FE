...
/**
 * Dropdown component để chọn sortBy (XP hoặc Streak)
 * @param {Object} props
 * @param {string} props.selectedSortBy - SortBy đang được chọn ('xp' | 'streak')
 * @param {Function} props.onSortByChange - Callback khi sortBy thay đổi
 */
export function SortByDropdown({
  ...
  const selectedLabel = SORT_OPTIONS.find(o => o.value === selectedSortBy)?.label || 'XP'
